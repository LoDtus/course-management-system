                ...
                <div className="first-footer md:flex">
                    ...
                    <div className="informations-footer basis-2/6 md:flex flex-col items-end mt-5">
                        ...
                        <div className='flex items-center mb-1'>
                            ...
                            <span className='md:hidden ml-3'>nguyentrunglong.150903@gmail.com</span>
                        </div>
                        <div className='flex items-center mb-1'>
                            <span className='itemInfo-footer sm:hidden md:inline mr-3'>Hoang Mai District, Hanoi, Vietnam</span>
                            ...
                            <span className='md:hidden ml-3'>Hoang Mai District, Hanoi, Vietnam</span>
                        </div>
                    </div>
                </div>
